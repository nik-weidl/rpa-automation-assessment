    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between p-5 border-b bg-slate-50/50">
          ...
          <button 
            onClick={onClose}
            className="h-9 w-9 flex items-center justify-center text-slate-600 hover:text-slate-900 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-full shadow-xs transition-all font-black text-sm"
        ...
        {/* modal footer */}
        <div className="p-4 border-t bg-slate-50 text-[10px] text-slate-500 font-medium px-6">
